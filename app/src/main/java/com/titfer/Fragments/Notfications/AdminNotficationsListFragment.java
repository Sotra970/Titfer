...
public class AdminNotficationsListFragment extends Fragment implements HolderListener {
    ...
    public AdminNotficationsListFragment() {
    ...
    void  get_data( ) {
        showLoading(true);
         ...
         usersdb1 = database.getReference("AdminNotification").limitToLast(mPageLimit);
    ...
    void  get_data(String lastSeenID ) {
        ...
        usersdb2 = database.getReference("AdminNotification").startAt(lastSeenID).limitToLast(mPageLimit);
