...
public class EventsListFragment extends Fragment implements HolderListener {
    ...
    View res_layout ;
    ArrayList<EventsModel> newsModels = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (res_layout == null){
            ...
            if (savedInstanceState !=null){
                ...
                newsModels = (ArrayList<EventsModel>) savedInstanceState.getSerializable("newsModels");
            }else {
              get_data();
            }
            bar_title.setText("Events");
            news_feed_setup();
    ...
    void news_feed_setup( ) {
        ...
        adapter = new EventsAdapter(newsModels,(AppCompatActivity) getActivity() , this);
    ...
    private int getIndexForKey(String key) {
        int index = 0;
        for (EventsModel newsModel : newsModels) {
    ...
    void  get_data( ) {
        ...
        usersdb1 = database.getReference("Events").limitToFirst(mPageLimit);
    ...
    void  get_data(String lastSeenID ) {
        ...
        usersdb2 = database.getReference("Events").startAt(lastSeenID).limitToFirst(mPageLimit);
    ...
    public void onHolderClicked(View view, Object child) {
        Log.e("image count " , ((EventsModel)child ).getImgs().size() +"");
        EventsDetailsFragment eventsDetailsFragment = new EventsDetailsFragment();
        eventsDetailsFragment.setEventsModel((EventsModel) child);
        eventsDetailsFragment.setFrom_tab("main_events");
        FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager() .beginTransaction();
        fragmentTransaction.setCustomAnimations(R.anim.enter_from_right, R.anim.exit_to_left, R.anim.enter_from_left, R.anim.exit_to_right);
        fragmentTransaction.replace(R.id.home_content_frame, eventsDetailsFragment);
