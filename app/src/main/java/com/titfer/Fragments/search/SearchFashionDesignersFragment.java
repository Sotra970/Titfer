 ...
 */
public class SearchFashionDesignersFragment extends Fragment  {
    ...
    public SearchFashionDesignersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (res_layout == null ){
            res_layout = inflater.inflate(R.layout.fragment_fashion_designers_search_sub_cat, container, false);
    ...
    @OnClick(R.id.ethinic)
    public void ethinic() {
        CatModel catModel =  new CatModel(getString(R.string.Ethnic) , R.drawable.ethinic) ;
        SearchDesignersListFragment searchDesignersListFragment = new SearchDesignersListFragment() ;
        searchDesignersListFragment.setCatModel(catModel);
        FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
        fragmentTransaction.setCustomAnimations(R.anim.enter_from_right, R.anim.exit_to_left, R.anim.enter_from_left, R.anim.exit_to_right);
