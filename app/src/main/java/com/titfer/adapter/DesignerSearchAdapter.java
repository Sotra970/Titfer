...
public class DesignerSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ArrayList<DesignerSearchModel> data ;
    ...
    public DesignerSearchAdapter(ArrayList<DesignerSearchModel> data, AppCompatActivity context , HolderListener holderListener) {
        this.data = data;
    ...
    public DesignerSearchModel getItem(int postion){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == LOADING){
            ...
            final DesignerSearchModel current = data.get(position);
        ...
        holder1.bio.setText('"'+current.getUserModel().getBio()+'"');
            recycleSetUP(current.getAlbumModels() , holder1.recyclerView ) ;
        }
