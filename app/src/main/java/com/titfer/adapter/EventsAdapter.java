...
public class EventsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EventsAdapter(ArrayList<EventsModel> data, AppCompatActivity context , HolderListener holderListener) {
        this.data = data;
    ...
    public EventsModel getItem(int postion){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == LOADING){
            ...
            final EventsModel current = data.get(position);
            ...
            Glide.with(context).load(current.getImgs().get(0))
