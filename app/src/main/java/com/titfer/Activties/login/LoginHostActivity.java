...
import com.titfer.Activties.signup.ProfessionalSignUpActivity;
...
public class LoginHostActivity extends AppCompatActivity implements  ConnStatesCallBack.FirebaseConnectionState ,GoogleApiClient.OnConnectionFailedListener {
    ...
    @OnClick(R.id.customer_signyp)
    void customer_signyp (){
    ...
    @OnClick(R.id.profession_signup)
    void profession_signup (){
        Intent i = new Intent(getApplicationContext(), ProfessionalSignUpActivity.class);
        startActivity(i);
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
    }
    ...
    void validatePhone(String  phone , final LoginActivity.OnValidateInterface onPhoneValidateInterface ){
    ...
    void validateEmail(String  email , final LoginActivity.OnValidateInterface onPhoneValidateInterface ){
    ...
    public void twitter_login(){
        ...
        TwitterloginButton.setCallback(new Callback<TwitterSession>() {
            ...
            public void success(Result<TwitterSession> result) {
                ...
                CookieSyncManager.createInstance(LoginHostActivity.this);
...
//        Toast.makeText(getApplicationContext() ,getString(R.string.no_conn) , Toast.LENGTH_LONG).show();
    ...
    private void soial_login(final UserModel userModel) {
        ...
        validateUid(userModel.getUid(), new LoginActivity.OnValidateInterface() {
            @Override
    ...
    void validateUid(String  uid , final LoginActivity.OnValidateInterface onPhoneValidateInterface ){
